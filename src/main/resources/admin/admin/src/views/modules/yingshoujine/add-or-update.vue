<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="图书数量" prop="tushushuliang">
          <el-input v-model="ruleForm.tushushuliang" 
              placeholder="图书数量" clearable  :readonly="ro.tushushuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="图书数量" prop="tushushuliang">
              <el-input v-model="ruleForm.tushushuliang" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="应收金额" prop="yingshoujine">
          <el-input v-model="ruleForm.yingshoujine" 
              placeholder="应收金额" clearable  :readonly="ro.yingshoujine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="应收金额" prop="yingshoujine">
              <el-input v-model="ruleForm.yingshoujine" 
                placeholder="应收金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.riqi = true;
          ...
          if(o=='tushushuliang'){
            this.ruleForm.tushushuliang = obj[o];
	    this.ro.tushushuliang = true;
            continue;
          }
          if(o=='yingshoujine'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yingshoujine/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yingshoujineCrossAddOrUpdateFlag = false;
                  this.parent.search();
