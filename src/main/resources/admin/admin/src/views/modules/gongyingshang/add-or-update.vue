<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="供应商类型" prop="gongyingshangleixing">
          <el-input v-model="ruleForm.gongyingshangleixing" 
              placeholder="供应商类型" clearable  :readonly="ro.gongyingshangleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="供应商类型" prop="gongyingshangleixing">
              <el-input v-model="ruleForm.gongyingshangleixing" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="主供商品" prop="zhugongshangpin">
          <el-input v-model="ruleForm.zhugongshangpin" 
              placeholder="主供商品" clearable  :readonly="ro.zhugongshangpin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="主供商品" prop="zhugongshangpin">
              <el-input v-model="ruleForm.zhugongshangpin" 
                placeholder="主供商品" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="详情备注" prop="xiangqingbeizhu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="详情备注"
                  v-model="ruleForm.xiangqingbeizhu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiangqingbeizhu" label="详情备注" prop="xiangqingbeizhu">
                    <span>{{ruleForm.xiangqingbeizhu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	gongyingshangleixing : false,
	zhugongshangpin : false,
	fuzeren : false,
	lianxidianhua : false,
	lianxidizhi : false,
	xiangqingbeizhu : false,
      },
      ruleForm: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gongyingshangmingcheng = true;
          ...
          if(o=='gongyingshangleixing'){
            this.ruleForm.gongyingshangleixing = obj[o];
	    this.ro.gongyingshangleixing = true;
            continue;
          }
          if(o=='zhugongshangpin'){
            this.ruleForm.zhugongshangpin = obj[o];
	    this.ro.zhugongshangpin = true;
            continue;
          }
          if(o=='fuzeren'){
	    ...
	    this.ro.lianxidizhi = true;
          ...
          if(o=='xiangqingbeizhu'){
            this.ruleForm.xiangqingbeizhu = obj[o];
	    this.ro.xiangqingbeizhu = true;
            continue;
          }
        }
      }
