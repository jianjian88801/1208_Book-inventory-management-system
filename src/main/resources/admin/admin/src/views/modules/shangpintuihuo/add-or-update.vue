<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="退货金额" prop="tuihuojine">
          <el-input v-model="ruleForm.tuihuojine" 
              placeholder="退货金额" clearable  :readonly="ro.tuihuojine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="退货金额" prop="tuihuojine">
              <el-input v-model="ruleForm.tuihuojine" 
                placeholder="退货金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="退货原因" prop="tuihuoyuanyin">
          <el-input v-model="ruleForm.tuihuoyuanyin" 
              placeholder="退货原因" clearable  :readonly="ro.tuihuoyuanyin"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="退货日期" prop="tuihuoriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tuihuoriqi" label="退货日期" prop="tuihuoriqi">
              <el-input v-model="ruleForm.tuihuoriqi" 
                placeholder="退货日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
