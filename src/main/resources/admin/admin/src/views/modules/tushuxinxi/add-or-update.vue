<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="图书状态" prop="tushuzhuangtai">
          <el-input v-model="ruleForm.tushuzhuangtai" 
              placeholder="图书状态" clearable  :readonly="ro.tushuzhuangtai"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.tushugaiyao = this.ruleForm.tushugaiyao.replace(reg,'../../../springbootk6oce/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
