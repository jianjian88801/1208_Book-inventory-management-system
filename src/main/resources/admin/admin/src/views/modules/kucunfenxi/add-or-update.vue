<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="当前库存" prop="dangqiankucun">
          <el-input v-model="ruleForm.dangqiankucun" 
              placeholder="当前库存" clearable  :readonly="ro.dangqiankucun"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="当前库存" prop="dangqiankucun">
              <el-input v-model="ruleForm.dangqiankucun" 
                placeholder="当前库存" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.riqi = true;
          ...
          if(o=='dangqiankucun'){
            this.ruleForm.dangqiankucun = obj[o];
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `kucunfenxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kucunfenxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
